        ...
        <div className='flex flex-col gap-5 md:gap-14 md:flex-row
            ...
            <div>
                ...
                <p className='text-gray-600 mb-4'>
                    ...
                    image generator.Whether you need a stunning visuals or 
                    uniquie artwork, our tool can help you create it in seconds.
                    Imagine it,describe it , and watch it come to life
                    instantly.
                </p>
                <p className='text-gray-600 mb-4'>
                    Simply type a text prompt, and our cutting-edge AI
                    will generate a high-quality image in seconds.From 
                    product visuals to character designs and portraits,
                    even concepts that don't exist can be visualized 
