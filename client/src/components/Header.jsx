...
const Header = () => {
  ...
  return (
    ...
    viewport={{once:true}}>
        ...
        <motion.h1 className='text-4xl max-w-[300px] sm:text-7xl sm:max-w-
        ...
        animate={{opacity:1,y:0}}>Unleash
            your creativity with our AI-powered text-to-image generator.
            Turn your imagination into visual art 
